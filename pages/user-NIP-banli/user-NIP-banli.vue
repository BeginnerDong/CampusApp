	...
	<view>
		...
		<view class="nipCard mglr4" v-if="mainData.length>0">
			<view class="item radius10 boxShaow" v-for="(item,index) in mainData">
				<view class="">
					<image class="topBaner" :src="item.mainImg&&item.mainImg[0]?item.mainImg[0].url:''" mode=""></image>
				</view>
				<view class="infor flexRowBetween">
					<view class="flex">{{item.title}}
						<view class="fs16 red ftw mgl10"><text class="fs12">￥</text>{{item.price}}</view>
					</view>
		...
		<view class="paywayShow whiteBj" v-show="is_paywayShow">
			...
			<view class="flexRowBetween" @click="seltPayway('1')">
				<view class="ll">
					<image class="payIcon" src="../../static/images/nipbanli-icon4.png" mode=""></image>
				</view>
				<view class="Rselt flexRowBetween">
					<view class="">支付宝支付</view>
					<view>
						<image class="seltIcon" :src="currPay==1?'../../static/images/nipbanli-icon.png':'../../static/images/nipbanli-icon1.png'"
						 mode=""></image>
					</view>
				</view>
			</view>
			<view class="flexRowBetween" @click="seltPayway('2')">
				<view class="ll">
					<image class="payIcon" src="../../static/images/nipbanli-icon3.png" mode=""></image>
				</view>
				<view class="Rselt flexRowBetween">
					<view class="">微信支付</view>
					<view>
						<image class="seltIcon" :src="currPay==2?'../../static/images/nipbanli-icon.png':'../../static/images/nipbanli-icon1.png'"
						 mode=""></image>
					</view>
				</view>
			</view>
